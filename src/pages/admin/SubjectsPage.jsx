...
export default function SubjectsPage() {
  ...
  // You can expand this to include other fields like subject_code if needed.
  const searchedSubjects = filteredSubjects.filter((item) =>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {searchedSubjects.length} of {filteredSubjects.length} subjects
          </Typography>
        </Box>
      </Paper>

      {/* Added: Alert for no search results */}
      {searchTerm && searchedSubjects.length === 0 && !loading && (
        <Alert
          severity="info"
          sx={{
            mb: { xs: 1.5, sm: 2, md: 3 },
      ...
      {/* Updated: Pass searchedSubjects to EntityList */}
      <EntityList
