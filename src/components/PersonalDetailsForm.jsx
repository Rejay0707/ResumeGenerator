// PersonalDetailsForm.jsx (Optional Update)
import { Box, TextField, Button } from "@mui/material";

export default function PersonalDetailsForm({ form, onChange, onSubmit, showSubmit = false }) { // Added showSubmit prop
  return (
    <Box component="form" display="flex" flexDirection="column" gap={2}>
      ...
      {showSubmit && ( // Conditionally render submit button
